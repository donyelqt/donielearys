...
export default function Hero() {
  return (
    <section className="relative min-h-[90vh] flex flex-col items-center justify-center text-center px-4 overflow-hidden">
      ...
      >
        <button className="px-6 py-3 bg-white text-black text-[10px] font-bold rounded-none flex items-center gap-2 hover:bg-white/90 transition-all group uppercase tracking-widest">
          View Projects
          <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
        </button>
        <button className="px-6 py-3 border border-white/20 text-white text-[10px] font-bold rounded-none hover:bg-white/5 transition-all uppercase tracking-widest">
          Contact Me
        </button>
      </motion.div>
      ...
      <motion.div
        ...
        className="mt-20 lg:mt-0 lg:absolute lg:bottom-10 flex gap-6 grayscale opacity-30 hover:grayscale-0 hover:opacity-100 transition-all"
      >
